...
//    Page<CentralOfficeProductRequest> findByFactory_Id(@Param("factoryId") Long factoryId, Pageable pageable);
//
//    @Query("SELECT r FROM CentralOfficeProductRequest r WHERE r.factory.factoryId = :factoryId AND r.status = :status")
//    Page<CentralOfficeProductRequest> findByFactory_IdAndStatus(@Param("factoryId") Long factoryId,
